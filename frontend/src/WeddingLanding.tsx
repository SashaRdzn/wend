          ...
          >
            <h2 className="font-display text-xl text-champagne sm:text-2xl lg:text-3xl">
              Подтвердите участие
                ...
                <p className=' text-xs'> Пожалуйста запоните анкету ниже и подтвердите свое присутствие до 17.05.2026 чтобы мы могли спланировать наше торжество наилучшим образом</p>
            {rsvpSlot ?? (
              <form
